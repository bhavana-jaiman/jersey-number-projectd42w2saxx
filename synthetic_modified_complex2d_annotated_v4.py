...
def combine_boxes(boxes,W,H,pad_ratio=.08):
...
def process_source(image_path,label_path,simple_image_path,number,out_path,image_size,args):
    ...
    # IMPORTANT: combine ALL existing number boxes first, then add a configurable
    # margin around the complete number region. This prevents leftovers such as
    # the trailing '5' in a source image containing 35 + an additional 5 box.
