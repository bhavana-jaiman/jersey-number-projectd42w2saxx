...
def main():
    ...
    ap.add_argument("--synthetic-height-min-ratio",type=float,default=.10,help="Minimum synthetic-number height as a fraction of the REAL input image/crop height; default 10%%")
    ap.add_argument("--synthetic-height-max-ratio",type=float,default=.18,help="Maximum synthetic-number height as a fraction of the REAL input image/crop height; default 18%%")
